      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-950 to-slate-950 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center h-screen px-4">
          <div className="text-center bg-gray-950/40 backdrop-blur-xl border border-gray-800/40 rounded-3xl p-12 max-w-md shadow-2xl">
            ...
            <p className="text-red-400 mb-8 text-lg leading-relaxed pb-4">{error}</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-950 to-slate-950 relative overflow-hidden">
      ...
      <div className="relative z-10 p-6 h-screen flex gap-6">
        {/* Conversations List */}
        <div className="w-1/3 bg-gray-950/25 backdrop-blur-xl border border-gray-800/30 rounded-3xl shadow-xl overflow-hidden">
          <div className="p-6 border-b border-gray-800/40">
            ...
            <p className="text-slate-500 text-sm pb-2">Connect with your skill exchange partners</p>
          </div>
          ...
          <div className="h-[calc(100vh-180px)] overflow-y-auto custom-scrollbar">
            {conversations.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-6">
                ...
                <h4 className="text-lg font-semibold text-white mb-2 pb-1">No conversations yet</h4>
        ...
        {/* Chat Window */}
        <div className="flex-1 bg-gray-950/25 backdrop-blur-xl border border-gray-800/30 rounded-3xl shadow-xl flex flex-col overflow-hidden">
          {selectedConversation && !error ? (
              ...
              <div className="p-6 border-b border-gray-800/40 bg-gradient-to-r from-gray-900/30 via-gray-950/20 to-gray-900/30">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      <div className="w-14 h-14 bg-gradient-to-r from-emerald-400 via-green-500 to-teal-600 rounded-2xl flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-emerald-500/20">
                  ...
                  {messages.map((message, index) => {
                    ...
                    return (
                      <div key={message._id}>
                        ...
                        >
                          <div className={`group flex items-end gap-3 max-w-[75%] ${isOwnMessage ? "flex-row-reverse" : "flex-row"}`}>
                            {!isOwnMessage && (
                            ...
                            >
                              ...
                              <p className="text-sm leading-relaxed relative pb-1">{message.text}</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    >
                      ...
                      {sending ? (
                        ...
                        <svg className="w-5 h-5 mx-auto relative transform group-hover:translate-x-0.5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1 flex items-center justify-center text-center px-6">
              <div>
                ...
                <h3 className="text-2xl font-bold bg-gradient-to-r from-white to-slate-200 bg-clip-text text-transparent mb-4 pb-2">
                  {error ? "Please select another conversation" : "Select a conversation"}
                </h3>
